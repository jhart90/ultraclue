...
export const SUSPECTS: SuspectCard[] = [
  ...
  { id: 'suspect-rose', type: 'suspect', title: 'Lady Rose', color: '#E58FA8', turnOrder: 8, phrase: 'All thorns beneath the petals.' },
  ...
  { id: 'suspect-sable', type: 'suspect', title: 'Judge Sable', color: '#3B342E', turnOrder: 15, phrase: 'Passes sentences, dodges his own.' },
  ...
  { id: 'suspect-coral', type: 'suspect', title: 'Miss Coral', color: '#F08071', turnOrder: 17, phrase: 'Soft-spoken, sharp-edged.' },
  ...
  { id: 'suspect-hazel', type: 'suspect', title: 'Mrs. Hazel', color: '#A8895C', turnOrder: 28, phrase: 'Watches with eyes that miss nothing.' },
  { id: 'suspect-cerulean', type: 'suspect', title: 'Professor Cerulean', color: '#2D7DD2', turnOrder: 29, phrase: 'Lost in the sky, grounded in deceit.' },
  { id: 'suspect-pearl', type: 'suspect', title: 'Lady Pearl', color: '#DDE3DA', turnOrder: 30, phrase: 'Lustrous, layered, hard to crack.' },
  ...
  { id: 'suspect-fuchsia', type: 'suspect', title: 'Madame Fuchsia', color: '#D9358A', turnOrder: 32, phrase: 'Electric company, dangerous company.' },
